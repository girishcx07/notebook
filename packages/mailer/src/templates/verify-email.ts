        ...
        <table width="560" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#1a1d27;border-radius:12px;overflow:hidden;border:1px solid #2d3148;max-width:560px;width:100%;">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#6c63ff 0%,#4f46e5 100%);padding:32px 40px;text-align:center;">
              <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;letter-spacing:-0.5px;">✉️ Verify Your Email</h1>
            </td>
          </tr>
          <!-- Body -->
          <tr>
            <td style="padding:40px;">
              <p style="margin:0 0 16px;color:#cbd5e1;font-size:15px;line-height:1.7;">Welcome aboard! 🎉</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  <td align="center">
                    <a href="${verifyUrl}" style="display:inline-block;background:linear-gradient(135deg,#6c63ff 0%,#4f46e5 100%);color:#ffffff;text-decoration:none;padding:14px 36px;border-radius:8px;font-size:15px;font-weight:600;letter-spacing:0.3px;">
              ...
              <p style="margin:28px 0 8px;color:#94a3b8;font-size:13px;line-height:1.6;">
                This link expires in <strong style="color:#e2e8f0;">24 hours</strong>. If you didn't create an account, you can safely ignore this email.
              </p>
